...
public class chuoiPhanUngForm extends javax.swing.JFrame implements KeyListener{
    ...
    public chuoiPhanUngForm() {
        ...
        initVar();
        initImage(jLabel3,"images/Chuoi.png");
        initImage(ok,"images/chuoi1.png");
    }
    ...
    private void initComponents() {
        ...
        giaithich.setFont(new java.awt.Font("Cooper Black", 2, 20)); // NOI18N
        giaithich.setRows(5);
        jScrollPane1.setViewportView(giaithich);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 520, 140));
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 690, 140));
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        // Chất nằm ngoài phạm vi chương trình.
        List <String> hc = knowledge.knowledge.all;
        for (JTextField tx : listOfC){
            String X = tx.getText();
            if (!PwL.checkIn(X, hc)){
                JOptionPane.showMessageDialog(
                        this,                         
                        "Chương trình chưa hiểu chất " + X + " là chất gì.\n" + 
                        "Bạn nên check lại.", 
                        "Thông báo", 
        ...
        if (show == null){
            JOptionPane.showMessageDialog(
                        this,                         
                        "Chuỗi phản ứng này nằm ngoài khả năng chương trình.", 
                        "Thông báo", 
                        JOptionPane.INFORMATION_MESSAGE);
            return ;
        }
