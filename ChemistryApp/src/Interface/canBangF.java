...
public class canBangF extends javax.swing.JFrame implements KeyListener{
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, -1, -1));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        List <String> hc = knowledge.getAllHC();
        File out = new File("knowledge/b.txt");
        try {
            FileWriter dtout = new FileWriter(out);
            for(String n: hc){
                dtout.write(n + "\n");
            }
            dtout.close();
        } catch (IOException ex) {
            Logger.getLogger(canBangF.class.getName()).log(Level.SEVERE, null, ex);
        }
